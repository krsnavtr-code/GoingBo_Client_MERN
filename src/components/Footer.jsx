...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1.5-4.5c0 .83-.67 1.5-1.5 1.5s-1.5-.67-1.5-1.5.67-1.5 1.5-1.5 1.5.67 1.5 1.5zm3.5-1.5c-.83 0-1.5-.67-1.5-1.5 0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5c0 .83-.67 1.5-1.5 1.5zm-6-6c-.83 0-1.5-.67-1.5-1.5S7.17 7.5 8 7.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" />
      ),
    },
  ];
  ...
  const contactInfo = [
    { type: "email", value: "krishna.trivixa@gmail.com" },
    { type: "phone", value: "+91 9084407615" },
    { type: "address", value: "Noida, India" },
  ];
    ...
    <footer className="bg-[var(--container-color-in)] text-text-light">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-xl font-bold mb-4">Krishna Avtar</h3>
            <p className="mb-4">
              Web Developer & Problem Solver crafting digital experiences that
              matter.
            </p>
          ...
          <div>
            ...
            {isSubscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="space-y-2">
                ...
                <button
                  type="submit"
                  className="bg-[var(--button-color)] py-1 px-2 rounded hover:opacity-90 transition-opacity cursor-pointer"
                >
                  Subscribe
                </button>
              </form>
